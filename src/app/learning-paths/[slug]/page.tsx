...
const paths: LearningPath[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "Framework Cookbook: Support Copilot", href: "/guides/framework-cookbook-support-copilot", time: "20 min", description: "Compare how one real workflow maps across major frameworks instead of reading framework pages in isolation." },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "Framework Cookbook: Support Copilot", href: "/guides/framework-cookbook-support-copilot", time: "20 min", description: "See how a real support workflow differs between backend-first and UI-first frameworks." },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "Case Study: Support Agent", href: "/guides/case-study-support-agent", time: "18 min", description: "Study a realistic production architecture where retrieval, policy, and escalation all have to work together." },
